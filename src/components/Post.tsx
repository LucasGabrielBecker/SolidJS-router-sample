...
export function PostTags({ tags, ...props }: { tags: string[] }) {
  return (
    <Flex
      p="$4"
...
export function PostReactions({ reactions }: { reactions: number }) {
  return (
    <Flex alignItems="center">
      <Heading ml="$2">{reactions}</Heading>
      <Icon ml="$2">
        <svg
